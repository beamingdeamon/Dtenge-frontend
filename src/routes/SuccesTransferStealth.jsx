...
export default function SuccesTransferStealth() {
  ...
  useEffect(() => {
    ...
    const transfer = () =>{
        axios.post(API_URL + "stealth-transfer/", { 
            s_public_address: window.localStorage.getItem("wallet"), 
            s_node_id: "O=Eurasian Bank, L=Nur-Sultan, C=KZ",
            s_signature: window.localStorage.getItem("stealth_signature"),
            s_stealth_address: window.localStorage.getItem('stealth_address'),
